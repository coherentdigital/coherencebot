 ...
 * and was copied into this package because the original class was not public
 * and hence not extensible. I needed to override the PDFParserConfig.properties
 * to arrange for heading parsing and didn't want to mess with the
