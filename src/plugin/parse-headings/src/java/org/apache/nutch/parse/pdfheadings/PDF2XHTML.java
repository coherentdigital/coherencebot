 ...
 * 
 * PDC: This is a local implementation of the same class in Tika. I needed to
 * override the writeString method in the original class so I could get my
 * greasy hands on the font information that the PdfTextStripper does not
 * include. And, sadly, the original class was not public so I couldn't extend
 * and override. To reduce the code size, I removed some methods not used by the
 * configuration.
 * 
...
class PDF2XHTML extends AbstractPDF2XHTML {
  ...
  PDF2XHTML(PDDocument pdDocument, ContentHandler handler, ParseContext context,
  ...
  protected void writeCharacters(TextPosition text) throws IOException {
    try {
      ...
      throw new IOException("Unable to write a character: " + text.getUnicode(),
          e);
    }
  }
